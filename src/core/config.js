/** SJTC Dashboard v3.0.9 — modular source */
/***********************
 * SJTC Production Department Dashboard v3.0.9
...
const AUTO_REFRESH_MS = 300000; // Auto-sync interval. Change to 30000 for 30 seconds, 300000 for 5 minutes.
